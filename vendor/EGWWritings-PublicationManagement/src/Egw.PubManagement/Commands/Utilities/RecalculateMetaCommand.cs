...
/// Recalculates TOC
/// </summary>
[Command("recalc meta", Description = "Recalculates TOC")]
public class RecalculateMetaCommand : ICommand
{
    ...
    /// Default constructor
    /// </summary>
    public RecalculateMetaCommand(WebApplication application)
    {
    ...
    public async ValueTask ExecuteAsync(IConsole console)
    {
        ...
        IRequestHandler<RecalculatePublicationMetadataCommand> handler = scope.ServiceProvider
            .GetRequiredService<IRequestHandler<RecalculatePublicationMetadataCommand>>();
        ...
        foreach (var publication in publications)
        {
            ...
            await handler.Handle(new RecalculatePublicationMetadataCommand(publication.PublicationId), ct);
        }
    }
}