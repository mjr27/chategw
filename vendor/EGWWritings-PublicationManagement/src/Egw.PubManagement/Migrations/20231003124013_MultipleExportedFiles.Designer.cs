...
namespace Egw.PubManagement.Migrations
{
    ...
    [Migration("20231003124013_MultipleExportedFiles")]
    partial class MultipleExportedFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.ArchivedPublication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ArchiveText")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("archive_text");
                    ...
                    b.HasIndex("Hash")
                        .IsUnique()
                        .HasDatabaseName("ix_publication_archive_hash");

                    b.HasIndex("PublicationId", "ArchivedAt")
                        .HasDatabaseName("ix_publication_archive_publication_id_archived_at");

                    b.HasIndex("DeletedAt", "PublicationId", "ArchivedAt")
                        .HasDatabaseName("ix_publication_archive_deleted_at_publication_id_archived_at");

                    b.ToTable("publication_archive", (string)null);
                });

            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.Cover", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PublicationId")
                        .HasDatabaseName("ix_covers_publication_id");

                    b.HasIndex("TypeId")
                        .HasDatabaseName("ix_covers_type_id");

                    b.ToTable("covers", (string)null);
                });

            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.CoverType", b =>
                {
                    ...
                    b.HasKey("Code")
                        .HasName("pk_cover_types");

                    b.ToTable("cover_types", (string)null);
                });
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.ExportedFile", b =>
                {
                    ...
                    b.HasIndex("IsMain", "PublicationId", "Type")
                        .HasDatabaseName("ix_publication_exports_is_main_publication_id_type");
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.GlobalOption", b =>
                {
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.ImportedPublicationSource", b =>
                {
                    b.Property<int>("PublicationId")
                        .HasColumnType("integer")
                        .HasColumnName("publication_id");
                    ...
                    b.HasKey("PublicationId", "Source")
                        .HasName("pk_publication_sources");

                    b.ToTable("publication_sources", (string)null);
                });
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.Language", b =>
                {
                    ...
                    b.HasIndex("EgwCode")
                        .IsUnique()
                        .HasDatabaseName("ix_languages_egw_code");
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.PublicationSynonym", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_publication_synonyms");

                    b.HasIndex("PublicationId", "Synonym")
                        .IsUnique()
                        .HasDatabaseName("ix_publication_synonyms_publication_id_synonym");

                    b.ToTable("publication_synonyms", (string)null);
                });
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.Cover", b =>
                {
                    b.HasOne("Egw.PubManagement.Persistence.Entities.Publication", "Publication")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_covers_publications_publication_id");

                    b.HasOne("Egw.PubManagement.Persistence.Entities.CoverType", "Type")
                        .WithMany("Covers")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_covers_cover_types_type_temp_id");
            ...
            modelBuilder.Entity("Egw.PubManagement.Persistence.Entities.PublicationSynonym", b =>
                {
                    b.HasOne("Egw.PubManagement.Persistence.Entities.Publication", "Publication")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_publication_synonyms_publications_publication_id");
